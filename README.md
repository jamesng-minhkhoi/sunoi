...
**SUNOI** ("SUN" + "OI" — *oi* being the Vietnamese term of endearment for calling someone dear). Home-run **drinks business** (mixed menu: milk tea, coffee, fresh juice/smoothies), delivery-only, Ho Chi Minh City, targeting nearby residents within a 2-3km radius. Currently in a **1–2 month home-kitchen test phase**, launching within 1-2 weeks, to validate operations before deciding on a permanent setup.
...
- **Price point**: 30k–100k VND/order
- **Capacity target**: ~20-30 drinks/day at launch
- **Delivery**: listing on multiple platforms from day 1 (GrabFood + ShopeeFood, likely + Baemin)
...
## Status
- Menu: 🟡 in progress — final drink list not yet provided (blocks pricing/ops/platform listings), drop it into `04-menu-product/` when ready
